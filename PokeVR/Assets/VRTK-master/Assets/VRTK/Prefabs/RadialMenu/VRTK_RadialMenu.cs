    ...
    public class VRTK_RadialMenu : MonoBehaviour
    {
        ...
        public void RegenerateButtons()
        {
            ...
            for (int i = 0; i < buttons.Count; i++)
            {
                ...
                if(textMeshPro == null)
                    textMeshPro = newButton.GetComponentInChildren<TextMeshPro>();

                textMeshPro.transform.localScale = new Vector3(25, 25, 1);
                ...
                else
                {
                    ...
                    textMeshPro.transform.localPosition = new Vector2(-1 * ((newButton.GetComponent<RectTransform>().rect.width / 2f) - (circle.thickness / 2f)), 0); 
                   ...
                   // textMeshPro.GetComponent<RectTransform>().sizeDelta = new Vector2(iconScale, iconScale);
                    //Rotate icons all vertically if desired
                    if (!rotateIcons)
                    {
                        buttonIcon.transform.eulerAngles = GetComponentInParent<Canvas>().transform.eulerAngles;
                        textMeshPro.transform.eulerAngles = GetComponentInParent<Canvas>().transform.eulerAngles;
                    }
                }
                //textMeshPro.GetComponent<RectTransform>().Rotate(new Vector3(0, 0, -90));
                //textMeshPro.GetComponent<RectTransform>().localPosition = new Vector3(230, 0, 0);
